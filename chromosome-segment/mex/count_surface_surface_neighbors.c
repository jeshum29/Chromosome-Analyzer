...
void compRoutine(double *regions_in, double *surfs_in, double *im_out, double *inds, mwSize dims[3]){
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    double *regions_in, *surfs_in, *im_out, *inds;
    ...
    compRoutine(regions_in, surfs_in, im_out, inds, dims);
